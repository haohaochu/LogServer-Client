// LogBase.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CLogBaseApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CLogBaseApp construction

CLogBaseApp::CLogBaseApp()
{
...
// The one and only CLogBaseApp object

CLogBaseApp theApp;


// CLogBaseApp initialization

BOOL CLogBaseApp::InitInstance()
{
...
void CLogBaseApp::GetIni()
{
	...
	GetPrivateProfileString("SYSTEM", "PATH", "c:\\quote\\log", m_chFileDir, 256, szIniPath);
	...
	// SERVER資訊
	memset(m_chElasticIP, NULL, 16);
	m_uServerPORT = GetPrivateProfileInt("SYSTEM", "SERVERPORT", 0, szIniPath);
	GetPrivateProfileString("SYSTEM", "ELASTICIP", "127.0.0.1", m_chElasticIP, 16, szIniPath);
	m_uElasticPORT = GetPrivateProfileInt("SYSTEM", "ELASTICPORT", 9200, szIniPath);
