...
public:
	...
	int Receive(char* pch, const int nSize, const int nSecs, const int nmilliSecs);
	...
	int ReceiveDatagram(char* pch, const int nSize, LPSOCKADDR psa, const int nSecs, const int nmilliSecs);
